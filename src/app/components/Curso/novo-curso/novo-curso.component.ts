...
export class NovoCursoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formulario = new FormGroup({
      nome: new FormControl(null, [Validators.required, Validators.maxLength(150)]),
      codigo: new FormControl(null, [Validators.required, Validators.maxLength(15)]),
      cursoTipoId: new FormControl(null, [Validators.required]),
      status: new FormControl(this.estados[0].value)
    });
