  ...
  ngOnInit(): void {
    ...
    this.cursoService.ObterCursoById(this.cursoId).subscribe(resultado =>{
      ...
      this.formulario = new FormGroup({
        ...
        nome: new FormControl(resultado.nome, [Validators.required, Validators.maxLength(150)]),
        codigo: new FormControl(resultado.codigo, [Validators.required, Validators.maxLength(15)]),
        cursoTipoId: new FormControl(resultado.cursoTipoId, [Validators.required]),
        status: new FormControl(resultado.status.toString())
      });
    });
  }
