...
export class NovaOfertaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formulario = new FormGroup({
      ...
      codigo: new FormControl(null, [Validators.required, Validators.minLength(1), Validators.maxLength(50)]),
      inicioOperacao: new FormControl(null, [Validators.required]),
      status: new FormControl(this.estados[0].value, [Validators.required]),
      usuarioId: new FormControl(localStorage.getItem('UsuarioId'))
    });
  }
